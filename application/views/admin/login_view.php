...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
		<img src="<?php echo base_url('assets/'); ?>dist/img/logo.png" height="50px">
      <a href=""><b>Span Pumps</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <div class="form-group">
          ...
          <select required="" name="position_type" class="form-control">
            ...
            <option value="area_manager">Area manager </option>            <option value="contractor">Contractor</option>
          </select>
        </div>
