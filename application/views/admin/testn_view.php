...
$filled_site_survey_form = isset($filled_site_survey_form) ? $filled_site_survey_form : '';
...
$filled_yield_test_form = isset($filled_yield_test_form) ? $filled_yield_test_form : '';
?>
                ...
                <form method="post" enctype="multipart/form-data" action="<?php echo base_url('Siteengineer/add_site_survey'); ?>">
                  ...
                  <div class="card-body team-form">
					<div class="form-group">
                      ...
                      <input type="date" class="form-control" name="site_survey_actual_date" value="<?= $site_survey_actual_date ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Source Depth</label>
                      <input type="number" class="form-control" name="source_depth" value="<?= $source_depth ?>" min="0" max="100" />
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Source Dia </label>
                      <input type="number" class="form-control" name="source_dia" value="<?= $source_dia ?>" min="0" max="32" />
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Static Water Level</label>
                      <input type="number" class="form-control" name="static_water_level" value="<?= $static_water_level ?>" min="0" max="100" />
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Pumping Water Level</label>
                      <input type="number" class="form-control" name="pumping_water_level" value="<?= $pumping_water_level ?>" min="0" max="100" />
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Pump Head Recommended</label>
                      <input type="number" class="form-control" name="pump_head_recommended" value="<?= $pump_head_recommended ?>" min="0" max="100" />
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Length of HDPE Pipe Required</label>
                      <input type="number" class="form-control" name="length_of_hdpe_pipe_required" value="<?= $length_of_hdpe_pipe_required ?>" min="0" max="115" />
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Cable Length required(Mtrs)</label>
                      <input type="number" class="form-control" name="cable_length_required" value="<?= $cable_length_required ?>" min="0" max="115" />
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Wire rope length required (Mtrs)</label>
                      <input type="number" class="form-control" name="wire_rope_length_required" value="<?= $wire_rope_length_required ?>" min="0" max="115" />
                    </div>
					<div class="form-group">
                    <label>Filled Site Survey Form</label>
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" name="filled_site_survey_form">
                      <label class="custom-file-label" for="customFile">Choose file</label>
                    </div>
                  </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Yield Test required </label>
                      <input type="number" class="form-control" name="yield_test_required" value="<?= $yield_test_required ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Yield test Start Date</label>
                      <input type="date" class="form-control" name="yield_test_start_date" value="<?= $yield_test_start_date ?>">
                    </div>
                  
                    <div class="form-group">
                      <label for="exampleInputEmail1">Yield Test End Date</label>
                      <input type="date" class="form-control" name="yield_test_end_date" value="<?= $yield_test_end_date ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Yield of Borewell (LPH)</label>
                      <input type="number" class="form-control" name="yield_of_borewell" value="<?= $yield_of_borewell ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Yield Test Status</label>
                      <input type="name" class="form-control" name="yield_test_status" value="<?= $yield_test_status ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Site Feasible Status</label>
                      <input type="name" class="form-control" name="site_feasible_status" value="<?= $site_feasible_status ?>">
                    </div>
					<div class="form-group">
                    <label>Filled Site Survey Form</label>
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" name="filled_yield_test_form">
                      <label class="custom-file-label" for="customFile">Choose file</label>
                    </div>
                  </div>
